...
namespace MyHotelApp.Infrastructure.Migrations
{
    ...
    [Migration("20240415191416_EditSeedRoomPrice")]
    partial class EditSeedRoomPrice
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "93d9a24b-4c0c-41f7-841b-2e383fd63a8f",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "af25c961-850e-4f90-99fb-59c8aba17703",
                            Email = "admin@mail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@MAIL.COM",
                            NormalizedUserName = "ADMIN@MAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEHF/pqFnPtWtFpcoFs+YI636MwazY70TwuJFJxnv6KeJlyanNh6GG8b8zKhM7sFsaw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "76bac436-0f57-44d3-9369-ebf436582794",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "29aa6df5-84a3-4c96-8341-ad28692a140f",
                            Email = "sa6a@mail.bg",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "400fdcce-f970-4518-b6d8-341923431075",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5124d50f-97db-461b-9017-c13b31610dea",
                            Email = "test@abv.bg",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9ee52eae-51b9-4bed-900d-abe0a9e98037",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("MyHotelApp.Infrastructure.Data.Model.ReservationRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("ReservationRoom Identifier");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"), 1L, 1);

                    b.Property<DateTime>("CheckInDate")
                        .HasColumnType("datetime2")
                        .HasComment("Date for check in");

                    b.Property<DateTime>("CheckOutDate")
                        .HasColumnType("datetime2")
                        .HasComment("Date for check out");

                    b.Property<bool>("IsApproved")
                        .HasColumnType("bit")
                        .HasComment("Is or not approve from admin");

                    b.Property<int>("RoomId")
                        .HasColumnType("int")
                        .HasComment("Room Id for reservation");

                    b.Property<string>("UserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("User Id of reservation");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CheckOutDate = new DateTime(2024, 4, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsApproved = false,
                            RoomId = 33,
                        ...
                        {
                            Id = 2,
                            CheckInDate = new DateTime(2024, 4, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckOutDate = new DateTime(2024, 4, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsApproved = false,
                            RoomId = 33,
                            UserId = "14c0d211-8033-4592-b98a-dad3c969c2e0"
                        },
                        ...
                        {
                            Id = 3,
                            CheckInDate = new DateTime(2024, 4, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckOutDate = new DateTime(2024, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsApproved = false,
                            RoomId = 33,
                            UserId = "14c0d211-8033-4592-b98a-dad3c969c2e0"
                        },
                        ...
                        {
                            Id = 6,
                            CheckInDate = new DateTime(2024, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("MyHotelApp.Infrastructure.Data.Model.Review", b =>
                {
                    ...
                    b.Property<string>("Description")
                        ...
                        .HasComment("Description of review");

                    b.Property<string>("IdReviewer")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Id of reviewer");

                    b.Property<bool>("IsReviewed")
                        .HasColumnType("bit")
                        .HasComment("Is or not reviewed from admin");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)")
                        .HasComment("Name of reviewer");

                    b.Property<int>("Rating")
                        .HasColumnType("int")
                        .HasComment("Rating of review");
            ...
            modelBuilder.Entity("MyHotelApp.Infrastructure.Data.Model.Room", b =>
                {
                    ...
                    b.Property<string>("ImgUrl")
                        ...
                        .HasComment("Url for room image");

                    b.Property<decimal>("Price")
                        .HasColumnType("decimal(18,2)")
                        .HasComment("Price of room");
                    ...
                    b.Property<int>("ViewTypeId")
                        .HasColumnType("int")
                        .HasComment("RoomView Identifier");
